  ...
  <div style="max-width: 560px; margin: 0 auto; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.35);">
    ...
    <div style="background-color: #ffffff; padding: 36px 32px 28px;">
      ...
      <div style="background-color: #ecfdf5; border-left: 4px solid #10B981; border-radius: 6px; padding: 14px 18px;">
        <p style="margin: 0; font-size: 13px; color: #10B981; line-height: 1.6;">
          <strong>Welcome!</strong> Your child's registration has been approved. You can now access all our services.
        </p>
      </div>
    </div>
